...
import { metricsAlertCheck } from "@/inngest/functions/metrics-alert";
import { generateReview, handleCommentReply } from "@/inngest/functions/review";

// Create an API that serves zero functions
export const { GET, POST, PUT } = serve({
	client: inngest,
	functions: [indexRepo, indexRepoIncremental, metricsAlertCheck, generateReview, handleCommentReply],
});
